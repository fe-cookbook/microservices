  ...
  <div class="register">
    <div class="register-content">
      ...
      <div class="register-form">
        <el-form :model="userForm" :rules="formRule" ref="userForm" size="medium">
          ...
          <el-form-item class="login-item" prop="checked">
            <el-checkbox class="check" v-model="userForm.checked">
              我已阅读并同意
              <router-link class="link" to>《启迪云用户协议》</router-link>和
              <router-link class="link" to>《隐私政策声明》</router-link>
            </el-checkbox>
          </el-form-item>
          <el-form-item class="login-item checked-item">
            <el-button @click="handleLogin" type="violet">同意协议并注册</el-button>
          </el-form-item>
        </el-form>
      </div>
    </div>
